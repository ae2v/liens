...
export function QrDownloads({ record }: { record: Pick<QrCodeRecord, 'trackingUrl' | 'foreground' | 'background'> }) {
  const query = new URLSearchParams({ data: record.trackingUrl, dark: record.foreground, light: record.background });
