...
import { SiDiscord, SiFacebook, SiInstagram, SiTwitch, SiYoutube } from "@icons-pack/react-simple-icons";
import type { ElementType } from "react";

const icons = {
  CalendarDays, Camera, Clock3, Discord: SiDiscord, Facebook: SiFacebook, Globe2, Instagram: SiInstagram,
  Linkedin, Link: LinkIcon, Mail, MapPin, Music2, Ticket, Twitch: SiTwitch, Youtube: SiYoutube,
};
